...
Στόχος: Γνωριμία με τη γλώσσα προγραμματισμού Python.
- Επισκόπηση της Python
- Εγκατάσταση της Python και ρύθμιση του περιβάλλοντος ανάπτυξης (IDE: PyCharm, VS Code)
...
Στόχος: Διδασκαλία στον έλεγχο της ροής ενός προγράμματος και στη δημιουργία επαναχρησιμοποιήσιμων κώδικα.
...
Μάθημα 3: Δομές Δεδομένων και Αλγόριθμοι
Στόχος: Εισαγωγή στις βασικές δομές δεδομένων και στην έννοια των αλγορίθμων.

- Λίστες, πλειάδες και λεξικά
- Σύνολα και οι λειτουργίες τους
- Αντιληπτικότητες λίστας
- Εισαγωγή στους αλγορίθμους: αναζήτηση και ταξινόμηση
- Βασική ανάλυση πολυπλοκότητας χρόνου

Μάθημα 4: Αντικειμενοστρεφής Προγραμματισμός (OOP)
Στόχος: Παροχή ισχυρής κατανόησης των αρχών OOP και της εφαρμογής τους στην Python.
...
Μάθημα 5: Βιβλιοθήκες και Πλαίσια Εργασίας για Μηχανολογικές Εφαρμογές
Στόχος: Επίδειξη της χρήσης δημοφιλών βιβλιοθηκών και πλαισίων εργασίας της Python για  εφαρμογές.
